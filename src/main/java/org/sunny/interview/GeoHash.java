 ...
 * 题目描述
 ...
 此题考察纬度的二进制编码：算法对纬度[-90, 90]通过二分法进行无限逼近
...
public class GeoHash {
    public static final int BOTTON_LIMIT = -90;
    public static final int UPPER_LIMIT = 90;
    ...
    public static void main(String[] args){
        ...
        while (high - low >= 5) {
            ...
            else if(number>=mid && number<=high){
                result.append("1");
                low = mid;
            }
